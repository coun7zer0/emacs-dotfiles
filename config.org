...
** Core
*** multiple-cursors
Agrega soporte para multiples cursores
...
*** Avy
Instala el paquete avy, este sirve para saltar a cualquier parte de
nuestro texto fácilmente.
...
*** Tree-sitter
Configura la descarga de los grammar para tree-sitter.
...
*** html-ts-mode
Instala el modo html-ts-mode si la version de Emacs es menor a Emacs
30.
...
*** Combobulate
Instala y configura Combobulate, el cual es una herramienta que nos
permite utilizar la funcionalidades que brinda Emacs en los lenguajes
de tipo lisp en lenguajes con soporte para tree-sitter.
...
#+begin_src emacs-lisp
    (use-package combobulate
        ...
        :load-path ("~/Documents/packages/combobulate"))
#+end_src
...
#+begin_src emacs-lisp
  (use-package lsp-bridge
    ...
    (:map lsp-bridge-mode-map
          ...
          ("C-c f r" . lsp-bridge-peek)
          ("C-c f R" . lsp-bridge-peek-though)
          ...
          ("C-c l d" . lsp-brdige-popup-documentation)
          ("C-c l V" . lsp-brdige-popup-documentation-scroll-up)
          ("C-c l v" . lsp-brdige-popup-documentation-scroll-down)
...
** JS, TS, JSX, TSX
*** Tree-sitter
configura cuando iniciar los modos treesitter para los diferentes
tipos de archivos
